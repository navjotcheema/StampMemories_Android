...
public abstract class DrawableClickListener implements View.OnTouchListener
{
     ...
     */
    public DrawableClickListener(@NonNull final TextView view, final int drawableIndex )
    {
     ...
     *            included to account for the size of a finger.
     */
    public DrawableClickListener(@NonNull final TextView view, final int drawableIndex, final int fuzz )
    {
        super();
        this.fuzz = fuzz;
    ...
    public static abstract class LeftDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public LeftDrawableClickListener(@NonNull final TextView view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public LeftDrawableClickListener(@NonNull final TextView view, final int fuzz )
        {
            super( view, DrawableClickListener.DRAWABLE_INDEX_LEFT, fuzz );
        }

        /* PUBLIC METHODS */
        public boolean isClickOnDrawable(final int x, final int y, @NonNull final View view, @NonNull final Rect drawableBounds, final int fuzz )
        {
    ...
    public static abstract class TopDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public TopDrawableClickListener(@NonNull final TextView view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public TopDrawableClickListener(@NonNull final TextView view, final int fuzz )
        {
    ...
    public static abstract class RightDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public RightDrawableClickListener(@NonNull final TextView view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public RightDrawableClickListener(@NonNull final TextView view, final int fuzz )
        {
    ...
    public static abstract class BottomDrawableClickListener extends DrawableClickListener
    {
         ...
         */
        public BottomDrawableClickListener(@NonNull final TextView view )
        {
         ...
         *            included to account for the size of a finger.
         */
        public BottomDrawableClickListener(@NonNull final TextView view, final int fuzz )
        {
